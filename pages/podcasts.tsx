...
export default function Podcasts() {
  return (
    <Layout title="Podcasts" desc="The podcasts I recommend checking out. Some publish regularly, others are short, one-off series.">
      <div className="prose max-w-none">
        <h1>Podcasts</h1>
        <p>Here are podcasts I recommend checking out. Some publish regularly, others are short, one-off series.</p>
        <ul>
